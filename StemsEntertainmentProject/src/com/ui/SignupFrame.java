...
public class SignupFrame extends javax.swing.JFrame implements Validator, Translator
{
    ...
    private void signupBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_signupBtnActionPerformed
        ...
        if (!isEmpty() && isValidRules(password))
        {
            if (DatabaseConfiguration.isConnected())
            {
                ...
                {
                    int updateCount = new Scripts().addUser(
                            username, id, phoneNumber, encrypt, gender, 
                            LocalDate.now()    
                    );
                ...
                {
                    PopupPane.errDialog(this, resources.getString("accexist"),
                            resources.getString("dbaccmsgerr"));
                }  
            } 
            else
            {
    ...
    @Override
    public void updateLanguagePreferences(String resourceFile, String locale)
    {

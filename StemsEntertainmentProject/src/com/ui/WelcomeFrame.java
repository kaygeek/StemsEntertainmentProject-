...
public class WelcomeFrame extends JFrame implements PropertyChangeListener
{
    ...
    private final String NAME = "preference";
    ...
    public WelcomeFrame() 
    {
        files = FileProcessor.createFile(NAME);
        initFile(setPath());
        files.loadFile();
        
        initComponents(); 
        ProgramScheduler.startDatabaseServer(this.rootPane);        
    ...
    private boolean setPath() {
        String path = new File(NAME + ".properties").getAbsolutePath();
    ...
    private void checkDatabaseStatus() 
    {
        ...
        else
        {
            ...
            {
                String username = files.getProperties().getProperty(
                        "dbusername");
                String password = files.getProperties().getProperty(
                        "dbpassword");              
                ...
                else
                {
                    DatabaseConfiguration.getConnection()
                            .configConnection(username, password, 1);                    
    ...
    private void removePreferenceIfExist()
    {

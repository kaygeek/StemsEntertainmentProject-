...
public class MenuFrame extends JFrame implements Translator, Validator
{
    ...
    private static boolean isUpdateName = false;
    private static boolean isUpdateNumber = false;

    private Map<String, Integer> popularMovies = new HashMap<>();
    private Map<String, Integer> popularSession = new HashMap<>();
    private final FileProcessor files;

    private static final Scripts script = new Scripts();
    private static final Set<String> uniqueMovies = new HashSet<>();;
    private static final Set<String> uniquePrices = new HashSet<>();
    ...
    public MenuFrame()
    {
        ...
        comboBoxListener();
        removeComponent(innerMainPanel);
        setUsername();
        ...
        else
        {
            ...
            if (checkRule())
            {
                if (!exists(movieTitle))
                {
                    ...
                    LocalDate date = releaseDate2.getDate().toInstant().atZone(
                    ...
                    if (DatabaseConfiguration.isConnected())
                    {
                        ...
                        int rowCount = script.addMovie(movieTitle, lang, type, date,
                                image, hrMin, age, price, descr, password
                        );

                        if ((rowCount > 0))
                        {
                            PopupPane.infoDialog(this,resources.getString(
                                    "movieinsert"),resources.getString(
                                    "moviehead")
                            );
                            displayButtonActionPerformed();
                        }
                        else
                        {
                            ...
                            PopupPane.infoDialog(this, msg, resources.getString(
                                    "moviehead2")
                            );
                        }
                    }
                ...
                {
                    PopupPane.infoDialog(this, resources.getString("moviedup"),
                            resources.getString("duphead")
                    );
                }
            }
        }
    ...
    private void uploadBtnActionPerformed(ActionEvent evt) {
        ...
        {
            PopupPane.infoDialog(this, resources.getString("cancelled"),
                    resources.getString("cancelmsg")
            );
        }
    }
        ...
        else
        {
            if (isVerified())
            {
                if (DatabaseConfiguration.isConnected())
                {
                    ...
                    double amount = Double.parseDouble(comboAmount
                            .getSelectedItem().toString().replaceAll("R", "")
                    );
                ...
                {
                    PopupPane.errDialog(this, resources.getString("dbservererr"),
                            resources.getString("dbservermsg")
                    );
                }
            }
        }
    ...
    private void exitLabelMouseMoved(MouseEvent evt) {
        exitLabel.setIcon(new ImageIcon(getClass().getResource(
                "/com/images/close2.png")));
    }
    ...
    private void saveButtonActionPerformed(ActionEvent evt) {
        ...
        {
            if (isUpdateName == true || isUpdateNumber == true)
            {
                int result = script.updateUserAccount(
                ...
                new Timer().schedule(new TimerTask()
                {
                    ...
                    public void run()
                    {
                        ...
                        if (result > 0)
                        {
                            PopupPane.infoDialog(welcomePanel, bundle.getString(
                                    "updateMsg"), bundle.getString("updateTitle")
                            );
                        }
                        else
                        {
                            PopupPane.errDialog(welcomePanel, bundle.getString(
                                    "updateErr"), bundle.getString("updateTitle")
                            );
                        }
                    }
                }, 850);
    ...
    {
        usernameLabel.setText(LanguageResources.capitalize(
                LoginFrame.getloggedUser())
        );
    }
    ...
    {
        final int[] VAL = {1, 2, 3, 4, 5, 6};
        final int SIZE = VAL.length;

        final JPanel[] PANEL_LIST = {panelAdd, panelPurchase, panelMovies,    
            panelBooking, panelPopular, panelSettings
        };

        final JPanel[] SUB_PANEL = {moviePanel, innerMainPanel, displayMoviesPanel,
        ...
        for (int index = 0; index < SIZE; index++)
        {
            if (VAL[index] == value)
            {
                SUB_PANEL[index].setVisible(false);
                welcomePanel.setVisible(false);
                continue;
            }
            PANEL_LIST[index].setBackground(new Color(36,91,99));
            SUB_PANEL[index].setVisible(false);
            welcomePanel.setVisible(false);
        }
    }
    ...
    private void validateCombo()
    {
        JComboBox[] combo = new JComboBox[] {
                langCombo2, ageCombo2, genreCombo2
        };

        boolean[] emptyList = new boolean[]
                {
                     langCombo2.getSelectedIndex()  == 0,
                     ageCombo2.getSelectedIndex()   == 0,
                     genreCombo2.getSelectedIndex() == 0
                };
    ...
    private void dialogMessage(int count)
    {
        if ((count > 0))
        {
            if ((response != null) && (response.length() > 0))
            {
                JOptionPane.showMessageDialog(this, resources.getString(
                        "ticketmsg"), resources.getString("tickethead"),
            ...
            {
                JOptionPane.showMessageDialog(this, resources.getString(
                        "ticketcancel"), resources.getString("tickethead2"),
                        JOptionPane.INFORMATION_MESSAGE
                );
            }
        }
        else
        {
            ...
            JOptionPane.showMessageDialog(this, msg, resources.getString(
                    "ticketerrhead"), JOptionPane.ERROR_MESSAGE
            );
        }
    }
    ...
    private void addMovieList()
    {
        ...
        if (DatabaseConfiguration.isConnected())
        {
            ...
            for (Movie movie : movieList) {
                uniqueMovies.add(movie.getTitle());
            }

            comboMovie.setModel(new DefaultComboBoxModel(
                    removeDuplicates(uniqueMovies)));
        }
        else {
            comboMovie.remove(0);
        }
    ...
    private void addAmountList()
    {
        ...
        if (DatabaseConfiguration.isConnected())
        {
            ...
            {
                if (uniquePrices.add(movie.getTitle())) {
    ...
    {
        LinkedList<Movie> data = script.getMovies();
        return data.stream().anyMatch((data1) ->
                (title.equalsIgnoreCase(data1.getTitle())));
    }
    ...
    private int initializeTicket(String name, String contact, double amount, String title)
    {
        ...
        if (exists(name, contact, title) == true)
        {
            count = script.updateTicketCount(
                    ++ticketCount, name, contact, movieId
            );
    ...
    private void setTableData()
    {
        ...
        /* Retrieve the user password and encrypt it using 'sha1hex' */
        String password = LoginFrame.getPassword();
            ...
            model.addRow(new Object[]
                    {
                         ...
                         ticketType.getName(), ticketType.getTime(),
                         formatDate(ticketType.getDate(), 1)
                    });
        }
    }
    ...
    private void prepareMovieTable()
    {
        ...
        if (movieList.size() > 0)
        {
            ...
            for (Movie movie : movieList)
            {
                model.addRow(new Object[]
                        {
                             movie.getTitle(), movie.getLanguage(), 
                             formatDate(movie.getDate(), 1),
    ...
    {
        loginJTable.getColumnModel().getColumn(0).setHeaderValue(
                resources.getString("datelabel"));
        loginJTable.getColumnModel().getColumn(1).setHeaderValue(
                resources.getString("timelabel"));
    }
    ...
    private void resetBookingsTableStructure()
    {
        ...
        bookingsTable.getColumnModel().getColumn(0).setHeaderValue(
                resources.getString("movietitle"));
        bookingsTable.getColumnModel().getColumn(1).setHeaderValue(
                resources.getString("ticket"));
        bookingsTable.getColumnModel().getColumn(2).setHeaderValue(
                resources.getString("customer"));
        bookingsTable.getColumnModel().getColumn(3).setHeaderValue(
                resources.getString("time"));
        bookingsTable.getColumnModel().getColumn(4).setHeaderValue(
    ...
    private void resetMoviesTable()
    {
        ...
        moviesTable.getColumnModel().getColumn(0).setHeaderValue(
                resources.getString("title"));
        moviesTable.getColumnModel().getColumn(1).setHeaderValue(
                resources.getString("language"));
        moviesTable.getColumnModel().getColumn(2).setHeaderValue(
                resources.getString("dateres"));
        moviesTable.getColumnModel().getColumn(3).setHeaderValue(
                resources.getString("dur"));
        moviesTable.getColumnModel().getColumn(4).setHeaderValue(
                resources.getString("price"));
        moviesTable.getColumnModel().getColumn(5).setHeaderValue(
                resources.getString("desc"));
        moviesTable.getColumnModel().getColumn(6).setHeaderValue(
                resources.getString("cover"));
    }
    ...
    private void resetPopularMoviesTable()
    {
        ...
        sessionTable.getColumnModel().getColumn(0).setHeaderValue(
                resources.getString("bookedsession"));
        sessionTable.getColumnModel().getColumn(1).setHeaderValue(
                resources.getString("views"));
    }
    ...
    {
        LinkedList<User> user = new Scripts().getUserAccount(
    ...
    private void listFrequency()
    {
        ...
        insertMovieData(list, popularMovies);
        insertMovieData(listView, popularSession);

        nextEntry = popularMovies.size();
    ...
    private void mostBookedSession()
    {
        ...
        List<Entry<String, Integer>> sessionList = reverseByFrequency(popularSession);
    ...
    private void sortMovies()
    {
        ...
        else
        {
            if (nextEntry > 1)
            {
                ...
                {
                    defaultContent(reverseByFrequency(popularMovies), movieCount);
                    previousButton.setEnabled(false);
            ...
            {
                defaultContent(reverseByFrequency(popularMovies), 0);
                previousButton.setEnabled(false);
                nextButton.setEnabled(false);
            }
        }
    ...
    {
        image5.setIcon(processImage(script.getMovieCover(sortedList.get(index)
                .getKey())));

        content4.setVisible(true);

        title.setText(String.format("%s (%s)",
                LanguageResources.capitalize(sortedList.get(index).getKey()),
                formatDate(script.getMovieByDate(sortedList.get(index).getKey())
                        , 0))
        );

        rating.setText(format(sortedList, index));

        genre.setText(script.getMovieByGenre(sortedList
                .get(index).getKey())
        );
    }
    ...
    {
        return String.format("%.1f", Double.parseDouble(list.get(index)
                .getValue().toString())
        );
    }
    ...
    public boolean isEmpty()
    {
        ...
        {
            PopupPane.errDialog(this, resources.getString("emptyfields"),
                    resources.getString("headermsg")
            );
    ...
    @Override
    public void updateLanguagePreferences(String resource, String locale)
    {
        ...
        langCombo2.setModel(new DefaultComboBoxModel(new String[]
                {
                        resources.getString("selectlang"), "English",
                        "Chinese", "Xhosa", "Zulu"
                }));
        ...
        genreCombo2.setModel(new DefaultComboBoxModel(new String[]
                {
                        resources.getString("selectgenre"), "Action", "Adventure",
                        "Animation", "Comedy", "Drama", "Horror", "Romance",
                        "Science Fiction"
                }));
        ...
        public void itemStateChanged(ItemEvent event)
        {
            ...
            for (Movie movie : movieList)
            {
                if (item.equalsIgnoreCase(movie.getTitle()))
                {
                    ...
                    {
                        double listPrice = Double.parseDouble(comboAmount
                                .getItemAt(inner).toString()
                                .replaceAll("R", "").trim()
                        );

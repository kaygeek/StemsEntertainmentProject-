...
public final class LoginFrame extends JFrame implements Translator, Validator
{
    ...
    private void btnLoginActionPerformed(ActionEvent evt) {
        String encrypt = DigestUtils.sha1Hex(
                PatternChecker.getInputValue(passwordField));
    ...
    private void verifyUser(String username, String password)
    {
        ...
        if (DatabaseConfiguration.isConnected())
        {
            ...
            if (name != null && name.equalsIgnoreCase(username))
            {
                ...
                PopupPane.infoDialog(this, resources.getString("userauth"),
                        resources.getString("auth"));

                new Scripts().logSession(LocalDate.now(), LocalTime.now(),
                        password);
    ...
    private void setHeaderMessage(String title)
    {
        ...
        if (!(count == null) && !count.equals("0")) {
            String username = LanguageResources.capitalize(filePro.getProperties()
                    .getProperty("session"));
     ...
     */
    @Override
    public void updateLanguagePreferences(String resFile, String language)
    {
